...
export default class Placeholders {
  ...
  setHoverAnimation() {
    ...
    this.tlHover
      ...
      .to(
        this.dom.images[0],
        { duration: 1, ease: "power3.inOut", rotation: -4 },
        "start"
      )
      .to(
        this.dom.images[1],
        { duration: 1, ease: "power3.inOut", rotation: -2 },
        "start"
      );
  }
  ...
  setExpandAnimation() {
    this.expand = () => {
      ...
      this.tlExpand
        ...
        .to(
          this.dom.images[0].querySelector("img"),
          { duration: 1.67, ease: "in-out-smooth", x: intersectX1 },
          "start"
        )
        .to(
          this.dom.images[1].querySelector("img"),
          { duration: 1.67, ease: "in-out-smooth", x: intersectX2 },
          "start"
        )
        .to(
          this.dom.images[2].querySelector("img"),
          { duration: 1.67, ease: "in-out-smooth", x: intersectX3 },
          "start"
        )
